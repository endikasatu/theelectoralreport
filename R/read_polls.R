#' @title read_polls
#'
#' @description Esta función lee las encuestas recopiladas por TheElectoralReport en función de los filtros escogidos y los guarda en un directorio especificado.
#'
...
read_polls <- function(tipo = "", ccaa = "", prov = "", mun = "", pollster = "") {
